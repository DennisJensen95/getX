...
class findbolig(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        self.FindBolig.login_findbolig(self.username_anna, self.password_anna)
        time.sleep(5)
        self.FindBolig.change_site(self.search)
        time.sleep(5)
        response = self.FindBolig.return_response(response)
